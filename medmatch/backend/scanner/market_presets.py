# -*- coding: utf-8 -*-
# Ported verbatim from personalized-product-scanner/server/marketPresets.ts — do not diverge.
SUPERMARKET_STORES = [{'id': 'traderjoes',
  'name': "Trader Joe's",
  'country': 'US',
  'logoBadge': 'TJ',
  'accentColor': '#ea580c',
  'categories': ['Clean Snacks', 'Plant Milk & Dairy', 'Dips & Spreads', 'Organic Pantry'],
  'description': 'Iconic clean-label grocery known for preservative-free snacks, organic staples, and '
 ...
 {'id': 'wholefoods',
  ...
  'description': 'Gold-standard organic grocer banning 300+ artificial preservatives, hydrogenated fats and '
 ...
 {'id': 'costco_us',
  ...
  'description': 'Leading US bulk retailer with high-grade Kirkland Signature organic staples and family '
                 'essentials.'},
 {'id': 'tesco',
  'name': 'Tesco (UK)',
  'country': 'UK',
  ...
  'description': 'UK’s leading supermarket with comprehensive FSA traffic light nutritional labeling and '
                 'Free-From allergens ranges.'},
 {'id': 'sainsburys',
  ...
  'description': 'Premium British supermarket offering clean ingredient standards and certified sustainable '
                 'sourcing.'},
 {'id': 'boots_uk',
  'name': 'Boots Pharmacy',
  'country': 'UK',
 ...
 {'id': 'carrefour_fr',
  ...
  'description': 'Leader de la grande distribution en France, pionnier du Nutri-Score et de l’agriculture '
                 'biologique (Label AB).'},
 {'id': 'monoprix_fr',
  ...
  'description': 'Enseigne urbaine française haut de gamme privilégiant les produits sans additifs '
                 'controversés et cosmétiques certifiés Cosmébio.'},
 {'id': 'rewe_de',
  'name': 'REWE Bio & Edeka',
  'country': 'DE',
  'logoBadge': 'REWE',
  ...
  'description': 'Führende deutsche Supermarktkette mit strengen Bio-Standards (Bioland, Demeter) und '
                 'Nutri-Score Transparenz.'},
 {'id': 'dm_drogerie',
  'name': 'dm-drogerie markt (Balea / Alverde)',
  'country': 'DE',
  'logoBadge': 'dm',
  'accentColor': '#7b1fa2',
  'categories': ['Naturkosmetik (Alverde)',
                 'Dermokosmetik (Balea Med)',
                 'dmBio Lebensmittel',
                 'Nahrungsergänzung'],
  'description': 'Europas beliebtester Drogeriemarkt für zertifizierte Naturkosmetik und saubere '
 ...
 {'id': 'conad_it',
  ...
  'description': 'Rete leader italiana per eccellenze enogastronomiche, filiera controllata e linea '
 ...
 {'id': 'coop_italia',
  ...
  'description': 'Cooperativa storica italiana all’avanguardia nell’eliminazione di olio di palma e '
                 'pesticidi controversi.'},
 {'id': 'mercadona_es',
  ...
  'description': 'Cadena líder en España famosa por su estricto etiquetado de alérgenos y productos '
                 'saludables Hacendado.'}]


MARKET_PRODUCTS = [{'barcode': '0098421004123',
 ...
 {'barcode': '0099482431201',
  ...
  'ingredientsText': 'Organic almondmilk (filtered water, organic almonds), calcium carbonate, sea salt, '
                     'potassium citrate, organic locust bean gum, gellan gum, vitamin A palmitate, '
                     'ergocalciferol (vitamin D2), d-alpha tocopherol (vitamin E).',
  'ingredientsList': ['Filtered Water',
                      'Organic Almonds',
                      'Calcium Carbonate',
                      'Sea Salt',
                      'Potassium Citrate',
 ...
 {'barcode': '5057753901234',
  ...
  'ingredientsText': 'Water, tapioca starch, rice flour, mixed seeds (11%) (sunflower seeds, brown linseed, '
                     'golden linseed, poppy seeds), potato starch, bamboo fiber, rapeseed oil, yeast, '
                     'psyllium husk powder, egg white powder, salt, hydroxypropyl methyl cellulose.',
 ...
 {'barcode': '3337875597123',
  ...
  'ingredientsText': 'Aqua/Water, Isocetyl Stearate, Squalane, Butyrospermum Parkii Butter / Shea Butter, '
                     'Dimethicone, Glycerin, Aluminum Starch Octenylsuccinate, Pentylene Glycol, PEG-100 '
                     'Stearate, Glyceryl Stearate, Cetyl Alcohol, Sphingobioma, Neurosensine.',
  'ingredientsList': ['Eau Thermale La Roche-Posay',
                      'Squalan Végétal',
                      'Beurre de Karité Bio',
                      'Glycérine',
                      'Sphingobioma (Probiotique)',
                      'Neurosensine'],
  'allergens': [],
  'labels': ['Sans Parfum',
             'Sans Conservateur',
             'Sans Alcool',
             'Hypoallergénique',
             'Emballage Ultra-Hermétique'],
  'safetyTier': 'clean',
  'familyCompatibilityScore': 98,
  'highlightTag': '0% Parfum • Brevet Sphingobioma',
  'priceEur': 19.5,
  'cosmetic': {'category': 'Soins Visage Peaux Réactives',
               'comedogenicRating': 1,
               'hasFragrance': False,
               'hasParabens': False,
               'hasSulfates': False,
               'hasAlcohol': False,
               'safetySummary': 'Formule dermatologique ultra-épurée testée sur peaux allergiques selon les '
                                'directives ANSM/EU.'}},
 ...
 {'barcode': '4058172931234',
  ...
  'ingredientsText': 'Aqua, Glycerin, Caprylic/Capric Triglyceride, Maris Sal (Totes Meer Salz), Panthenol, '
                     'Ceramide NP, Tocopherol, Allantoin.',
  ...
  'priceEur': 3.95,
  'cosmetic': {'category': 'Medizinische Hautpflege',
               'comedogenicRating': 0,
               'hasFragrance': False,
               'hasParabens': False,
               'hasSulfates': False,
 ...
 {'barcode': '8480000151234',
  ...
  'ingredientsText': 'Hortalizas frescas (93%) (tomate, pimiento, pepino, cebolla), aceite de oliva virgen '
                     'extra (2.6%), vinagre de jerez reserva, sal, ajo.',
  'ingredientsList': ['Tomate Fresco',
                      'Pimiento',
                      'Pepino',
                      'Cebolla',
